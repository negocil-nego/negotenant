package com.negocil.nego_tenant.modules.tenant.model

import com.fasterxml.jackson.annotation.JsonIgnore
import com.negocil.nego_tenant.modules.datasource.model.DatasourceTenant
import com.negocil.nego_tenant.modules.tenant.controller.response.TenantResponse
...
class Tenant(
    ...
    var datasources: MutableList<DatasourceTenant> = mutableListOf(),
    ...
    fun toResponse(): TenantResponse = TenantResponse(name, uuid)
